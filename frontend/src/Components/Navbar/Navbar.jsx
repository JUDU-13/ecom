import React, { useState, useContext, useRef } from 'react'; // FIXED: Added useRef import
import './Navbar.css';
...
const Navbar = () => {
    // State to track the active menu item, initialized to "shop"
    ...
    return (
        <div className='navbar'>
            ...
            <ul ref={menuRef} className='nav-menu'>
                {/* Each list item updates the state and contains a Link for navigation */}
